	...
	: State(InGainState)
{
	...
	std::initializer_list<ParameterPair> List =
	{
		...
		{ volume_gain(0.f),					{ "Input volume",		static_cast<void*>(&ThisState.InputVolume) } },
		{ volume_gain(0.f),					{ "Output volume",		static_cast<void*>(&ThisState.OutputVolume) } },
		...
		{ volume_gain(0.f),					{ "1 threshold",		static_cast<void*>(&ThisState.FirstCompressor.Threshold) } },
		...
		{ volume_gain(0.f),					{ "1 pump gain",		static_cast<void*>(&ThisState.FirstCompressor.PumpGain) } },
		...
		{ volume_gain(0.f),					{ "2 threshold",		static_cast<void*>(&ThisState.SecondCompressor.Threshold) } },
		...
		{ volume_gain(0.f),					{ "2 pump gain",		static_cast<void*>(&ThisState.SecondCompressor.PumpGain) } },
