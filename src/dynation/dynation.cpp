	...
	: State(InGainState)
{
	...
	std::initializer_list<ParameterPair> List =
	{
		...
		{ 1.f,								{ "Input volume",		static_cast<void*>(&ThisState.InputVolume) } },
		{ 1.f,								{ "Output volume",		static_cast<void*>(&ThisState.OutputVolume) } },
		...
		{ 0.f,								{ "1 threshold",		static_cast<void*>(&ThisState.FirstCompressor.Threshold) } },
		...
		{ 0.f,								{ "2 threshold",		static_cast<void*>(&ThisState.SecondCompressor.Threshold) } },
		...
		{ 1.f,								{ "2 pump gain",		static_cast<void*>(&ThisState.SecondCompressor.PumpGain) } },
